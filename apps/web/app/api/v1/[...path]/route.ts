...
// Allow large file uploads to pass through (capped at Vercel Hobby plan limit)
...
async function proxyToBackend(request: NextRequest): Promise<Response> {
  ...
  // Just under maxDuration so requests can complete before being aborted with a 504.
